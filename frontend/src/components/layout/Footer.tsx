      ...
      <div className="container mx-auto px-4 py-8 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          <div>
            ...
            <p className="text-sm">
              Your trusted partner for seamless global importing. Over three decades of simplifing complexities, whilst ensuring your goods arrive efficiently and reliably.
            </p>
          </div>
          <div>
