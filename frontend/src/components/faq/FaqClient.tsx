...
export const metadata: Metadata = {
  title: "End-to-End Supply Chain Solutions | Source One",
...
export default function ServicesPage() {
  return (
    <div className="space-y-16 md:space-y-24">
      ...
      <section className="py-16 md:py-24 bg-primary text-primary-foreground rounded-lg shadow-xl text-center">
      ...
      {/* Container Optimization Tool Section */}
      <section className="py-12 bg-accent text-accent-foreground rounded-lg">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-4 flex items-center justify-center">
            <BarChart3 className="mr-3 h-8 w-8 text-[#5DA9E9]" /> Container Optimization Tool
          </h2>
          <p className="max-w-2xl mx-auto text-lg mb-8">
            Maximize your shipping efficiency and reduce costs. Our experts can analyze your container loads to find potential savings.
          </p>
          <form className="max-w-xl mx-auto flex flex-col sm:flex-row gap-4 items-center justify-center">
            <Input 
              type="email" 
              placeholder="Enter your email for analysis" 
